...
#define STRESS_FUNCTION s21_fmod
#define HEALTHY_FUNCTION fmod
#define STRESS_FUNCTION_Str "s21_fmod(x)"
#define HEALTHY_FUNCTION_Str "fmod(x)"
...
Suite *add_suite_HEALTHY_FUNCTION(void) {
  Suite *suit = suite_create("FMOD_TEST");
  TCase *tc_core = tcase_create("FMOD_TEST");
