...
#define STRESS_FUNCTION s21_sqrt
#define HEALTHY_FUNCTION sqrt
#define STRESS_FUNCTION_Str "s21_sqrt(x)"
#define HEALTHY_FUNCTION_Str "sqrt(x)"
...
Suite *add_suite_HEALTHY_FUNCTION(void) {
  Suite *suit = suite_create((HEALTHY_FUNCTION_Str "_TEST"));
  TCase *tc_core = tcase_create((HEALTHY_FUNCTION_Str "_TEST"));
